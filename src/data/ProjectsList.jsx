export const ProjectsList = {
  projects: [
    ...
    },
    {
      ...
      description: "An innovative AI-powered mock interview application that helps users prepare for technical interviews. The app provides real-time feedback, customized interview questions, and performance analytics to improve interview skills.",
      technologies: ["TypeScript", "React.js", "AI/ML", "Node.js"],
    },
    {
      name: "ATS Resume Expert",
      description: "A Python-based resume analysis tool that helps users optimize their resumes for Applicant Tracking Systems (ATS). Features include keyword optimization, format checking, and personalized improvement suggestions.",
      technologies: ["Python", "NLP", "Machine Learning"],
    },
    {
      name: "MERN Blog App",
      description: "A comprehensive full-stack blog application built with the MERN stack. Features include user authentication, real-time updates, rich text editing, and responsive design for optimal viewing across all devices.",
      technologies: ["MongoDB", "Express.js", "React.js", "Node.js", "JWT"],
    },
    {
      name: "QR Code Generator for Google Maps",
      description: "A specialized QR code generation tool that creates scannable codes linking directly to Google Maps locations. Perfect for businesses, events, and location sharing.",
      technologies: ["Python", "Qrcode", "Pillow", "Google Maps API"],
    },
  ],
};
